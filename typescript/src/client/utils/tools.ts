...
export function taskbarSkill(_0x4ba715: any, _0x2edaa2: any, _0x562abd: any, _0x4c19e6: any) {
    return new Promise(resolve => {
        global.exports["arp-interface"].taskBarSkill(_0x4ba715, _0x2edaa2, resolve, _0x562abd, _0x4c19e6);
    });
}

export async function _0x102e92(_0x2f8223: any, _0x5add81: any, _0x3befad: any, _0x3b67e5 = false) {
    let _0xa0f7ec = false;

    _0x3b67e5 && global.exports["arp-interface"].clearSkillCheck();

    for (let i = 0; i < _0x3befad; i++) {
        if (!_0xa0f7ec) {
            const progress = await taskbarSkill(_0x2f8223, _0x5add81, i % 2 !== 0, _0x3b67e5);
            if (progress !== 100) _0xa0f7ec = true;
        }
    }
