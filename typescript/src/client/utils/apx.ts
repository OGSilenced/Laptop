...
//let APX: any = global.exports["apx"].GetLibrary();

// setImmediate(async () => {
//     await Delay(5);
//     APX = global.exports["apx"].GetLibrary();
// })
...
export const Zones = {
    ...
    addBoxZone: (id: string, zone: string, pCoords: any, pLength: number, pWidth: number, pOptions: any, pData = {}) => {
        console.log("addBoxZone", id, zone, pCoords, pLength, pWidth, pOptions, pData);
...
export const Interface = {
    ...
    addPeekEntryByFlag: (flag: string | string[], data: any, options: any) => {
